...
TARGET_DEVICE void run_example(double *inp, double *out, double* eout, double* euout) 
{
    ...
    __fpbits64_unpacked eux = __fp64emu_unpacked_from_double(dx);
    __fpbits64_unpacked euy = __fp64emu_unpacked_from_double(dy);
    __fpbits64_unpacked euz = __fp64emu_unpacked_from_double(dz);
    __fpbits64_unpacked euw = __fp64emu_unpacked_from_double(dw);
    // unpacked multiply
    __fpbits64_unpacked eures_mul = __fp64emu_unpacked_mid_dmul(eux, euy);
    ...
    // unpacked add
    __fpbits64_unpacked eures_add = __fp64emu_unpacked_mid_dadd(eux, euy);
    ...
    // unpacked mad
    __fpbits64_unpacked eures_m1  = __fp64emu_unpacked_mid_mad(eux, euy, euz);
    euout[2]                      = __fp64emu_unpacked_to_double(eures_m1);
    // unpacked dot
    __fpbits64_unpacked eures_dot = __fp64emu_unpacked_mid_dot(eux, euz, euy, euw);
    euout[3]                      = __fp64emu_unpacked_to_double(eures_dot);
    
    __fpbits64_unpacked upoly = __fp64emu_unpacked_mid_dmul(eux,__fp64emu_unpacked_from_double(C7));
