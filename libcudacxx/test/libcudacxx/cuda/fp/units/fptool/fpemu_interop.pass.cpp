...
//  fp64_tool's device paths call the global intrinsics of the same name, so an
...
//  compile as soon as both headers are included. fp64_tool therefore spells them
//  ::__dadd_rn.
//
